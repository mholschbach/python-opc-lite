...
@pytest.mark.parametrize("uri_str,expectation",
                         [('/_rels/.rels', True),
...
@pytest.mark.parametrize("zipname, expectation",
...
@pytest.mark.parametrize("uri_str, rel_target_uri_str, expectation", [
    ...
    ('/ppt/slides/slide1.xml', "../embeddings/Microsoft_Excel_Worksheet.xlsx",
     "/ppt/embeddings/Microsoft_Excel_Worksheet.xlsx"),
    ('/ppt/handoutMasters/handoutMaster1.xml',
     "../theme/theme4.xml", "/ppt/theme/theme4.xml"),
])
