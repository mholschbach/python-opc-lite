...
from opc.coreprops import PropertyItem
from opc.parser import ElementBase


def test_coreprops_raise_valueerror_for_unsupported_properties(
        core_properties):
...
def test_property_item_raises_error_if_nondt_object_given_for_dt_props(
        core_properties):
