...
#     p = Package(Path(__file__).parent / 'data'/ 'blank.pptx')
#     p.read()
#     return p.types
...
@pytest.mark.parametrize("uri_str, type", [("presentation_uri_str", "presentation_type"), ("thumbnail_url_str", "thumbnail_type")])
...
def test_add_default(types, part):
    ...
    assert types.get_type(part.uri.str) == part.type
