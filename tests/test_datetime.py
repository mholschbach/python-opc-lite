...
def test_dt_to_w3cdtf_from_timezone_aware_dt_object():
    ...
    dt_obj = datetime(year=2023, month=9, day=26, hour=20, minute=31, second=32, tzinfo=tz)
...
def test_dt_from_w3cdtf_from_string():
    ...
    assert dt_stamp == datetime(year=2023, month=9, day=26, hour=20, minute=31, second=32).timestamp()
